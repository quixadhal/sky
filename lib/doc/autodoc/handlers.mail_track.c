...
.SH Includes
.SP 5 5
This class includes the following files /include/mail_track.h and /include/mail.h.
.EP
...
.SI 3
* %^BOLD%^query_controlled_list%^RESET%^
.EI
.SI 5
...
.EI
.SP 9 5
1 if this is a controlled list, 0 if not
...
.EI
.SP 9 5
list_name - the mailing list to remove the controller from
.EP
.SP 9 5
