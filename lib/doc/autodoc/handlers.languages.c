...
The function garble_say, garble_tell, garble_shout and garble_written shoud be defined on the garbling object. They should return the entire string to print.  So if the routine returns 0 nothing is printed. 
.EP
.SP 10 5
...
.EI
.SP 9 5
lang - the language to get the size of
.EP
.SI 7
%^BOLD%^Returns:%^RESET%^
.EI
.SP 9 5
the size of each letter in standard handwriting
.EP
