...
.SH Inherits
.SP 5 5
This class inherits the following classes /std/basic/light and /std/basic/move.
.EP

.SH Includes
.SP 5 5
This class includes the following files /include/move_failures.h and /include/money.h.
.EP
