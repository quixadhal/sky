...
.SH Inherits
.SP 5 5
This class inherits the following classes /global/player/auto_load and /std/room/basic_room.
.EP

.SH Includes
.SP 5 5
This class includes the following files /include/move_failures.h, /include/mail.h and /include/money.h.
.EP
