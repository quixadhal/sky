...
.EI
.SP 9 5
the xp reward of the quest, -1 on failure
.EP

.SI 3
* %^BOLD%^query_quest_xps%^RESET%^
.EI
.SI 5
int * query_quest_xps()
.EI
...
.EP
.SP 9 5
amount - the amount of xp reward of the quest
.EP
.SI 7
%^BOLD%^Returns:%^RESET%^
.EI
