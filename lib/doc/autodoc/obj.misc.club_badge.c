...
.SH Inherits
.SP 5 5
This class inherits the following classes /std/basic/club_insignia and /obj/clothing.
.EP

.SH Includes
.SP 5 5
This class includes the following files /include/time.h, /include/broadcaster.h and /include/clubs.h.
.EP
