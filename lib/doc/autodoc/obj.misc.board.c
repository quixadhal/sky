...
.SI 3
* %^BOLD%^query_post_to%^RESET%^
.EI
.SI 5
string query_post_to()
.EI
...
.SI 3
* %^BOLD%^set_post_to%^RESET%^
.EI
.SI 5
void set_post_to(string val)
.EI
