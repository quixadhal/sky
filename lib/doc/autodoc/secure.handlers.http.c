...
.SH Includes
.SP 5 5
This class includes the following files /secure/include/socket_errors.h, /secure/include/http.h, /include/localtime.h, /secure/include/config.h, /include/runtime_config.h, /include/mime.h and /secure/include/network.h.
.EP
...
.SI 3
* %^BOLD%^query_server_ip%^RESET%^
.EI
.SI 5
string query_server_ip()
.EI

.SI 3
* %^BOLD%^query_status_line%^RESET%^
.EI
.SI 5
...
.EI
.SP 9 5
err - the error to get more info on
