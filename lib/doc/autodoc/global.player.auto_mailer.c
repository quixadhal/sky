...
.SH Includes
.SP 5 5
This class includes the following files /include/mail.h.
.EP
...
.EI
.SI 5
void auto_mail(string to, string from, string sub, string cc, string body, int send_inter, string only_to)
.EI
.SP 7 5
