...
.SH See also
.SP 5 5
/handlers/club_handler.c and /std/room/club_control_room.c

.EP
.SH Includes
.SP 5 5
This class includes the following files /secure/include/login.h, /include/time.h, /include/player_handler.h, /include/broadcaster.h, /include/clubs.h and /secure/include/login_handler.h.
.EP
...
.EP
.SP 9 5
online - print only the online members
.EP
.SI 7
%^BOLD%^Returns:%^RESET%^
.EI
...
.EI
.SI 5
string www_club_list(string person, int print_families)
.EI
.SP 7 5
