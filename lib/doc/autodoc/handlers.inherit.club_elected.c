...
.SH Inherits
.SP 5 5
This class inherits the following classes /handlers/inherit/club_family.
.EP

.SH Includes
.SP 5 5
This class includes the following files /include/board.h, /include/mail.h, /include/time.h and /include/clubs.h.
.EP
