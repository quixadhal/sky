...
.SH Includes
.SP 5 5
This class includes the following files /include/cmds/options.h, /include/time.h, /include/obj_parser.h, /include/player.h, /include/colour.h, /include/clubs.h and /include/playtesters.h.
.EP
...
.EI
.SI 5
int add_option(string name, mixed type, int cre_only, function set_function, function query_function)
.EI
.SP 7 5
...
.EI
.SI 5
void add_option_to_mapping(mapping array, string name, mixed type, int cre_only, function set_function, function query_function)
.EI
.SP 7 5
