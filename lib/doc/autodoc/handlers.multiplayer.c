...
.SH Includes
.SP 5 5
This class includes the following files /include/player_handler.h, /include/playerinfo.h and /secure/include/login_handler.h.
.EP
...
.EI
.SP 9 5
git - the name of the player to remove
.EP
.SI 7
%^BOLD%^Returns:%^RESET%^
.EI
...
.EI
.SP 9 5
p_name - the name being checked
.EP
.SP 9 5
type - the type of login call
.EP
