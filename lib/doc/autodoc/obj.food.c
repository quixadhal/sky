...
.SH Inherits
.SP 5 5
This class inherits the following classes /obj/cont_medium.
.EP

.SH Includes
.SP 5 5
This class includes the following files /include/weapon.h, /include/move_failures.h, /include/bits_controller.h, /include/diseases.h and /include/drinks.h.
.EP
...
.EI
.SP 9 5
1 if the food is a liquid, and 0 if it is not
.EP
...
.SI 3
* %^BOLD%^query_food_type%^RESET%^
.EI
.SI 5
string query_food_type()
.EI
.SP 7 5
...
.EI
.SP 9 5
1 if it is in pieces, 0 if otherwise
...
.SI 3
* %^BOLD%^set_food_type%^RESET%^
.EI
.SI 5
void set_food_type(string type)
.EI
.SP 7 5
