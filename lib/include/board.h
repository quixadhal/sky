 ...
 */
#define BOARD_HAND "/handlers/board_handler"
/**
 * The path to the web board reader.
 */
#define BOARD_WEB "/www/secure/boards"

/**
 * The index into the subject array that is the subject.
 * @see /handlers/board_handler->get_subjects()
 */
#define B_SUBJECT 0
/**
 ...
 * another file.
 */
#define B_PRIV_ACCESS_RESTRICTED_METHOD 5
