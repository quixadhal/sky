...
#define AUTODOC_FILE "/secure/handlers/autodoc/autodoc_file"
/** The path of the file to make the resulting nroff files. */
#define AUTODOC_NROFF "/secure/handlers/autodoc/autodoc_nroff"
/** The path of the file to make the html files. */
#define AUTODOC_HTML "/secure/handlers/autodoc/autodoc_html"
/** The main autodoc handler object. */
#define AUTODOC_HANDLER "/secure/handlers/autodoc/autodoc_handler"
...
#define HTML_DOC_DIR "/www/secure/autodoc/"

/** Where to save the parsed files. */
#define AUTODOC_SAVE_DIR "/save/autodoc/"
