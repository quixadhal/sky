(streak
   ...
   (single
      (no-arguments
       ...
       (rest "$mcname$ sheds all $mposs$ clothes and streaks around the room naked.")
      )
      (arguments
 ...
 (rest "$mcname$ sheds all $mposs$ clothes and streaks around the room $arg$.")
      )
   )
   (targeted
      (no-arguments
         (self   "You shed your clothes and streak by $hcname$.")
         (target "$mcname$ sheds $mposs$ clothes and streaks by you.")
         (rest   "$mcname$ sheds $mposs$ clothes and streaks by $hcname$.")
      )
 (arguments
      (arguments laughing, screaming, in a frenzy, with naughty bits flapping,
        panting, frightening everyone,with your frog,backwards,
      ...
      (target "$mcname$ sheds $mposs$ clothes and streaks by you $arg$.")
      (rest   "$mcname$ sheds $mposs$ clothes and streaks by $hcname$ $arg$.")
      )
   )
)
