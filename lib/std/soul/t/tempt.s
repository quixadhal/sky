(tempt
  ...
  (pattern "[with|to] <string> <indirect:any-living>")
  (pattern "<indirect:any-living> [with|to] <string>")
  (single
    (no-arguments
      (self "You tempt fate.")
  ...
  (targeted
    ...
    (arguments
      ...
      (target "$mcname$ tempts $arg$ with you.")
      (rest   "$mcname$ tempts $arg$ with $hcname$.")
    )
  )
)
