...
void setup() {
    ...
    add_exit("back", SIT+ "sitroom2","path");
...
void make_warrior() 
{
    ...
    warrior = clone_object( NPC_OBJ );
    warrior->set_name("warrior");
    warrior->set_short("warrior");
    warrior->set_long("This is an example warrior.\n");
