...
void setup() {
    ...
    add_item( "magazines",
      ({ "long", "Architectural and travel magazines sit on the "
        ...
        "read", "\"The Church of Calarien\", "
        "\"Beautiful marketsquare at Calarien!\", \"Design of the mystical labyrinth.\", "
        "and \"Scenic tours across Calarien!\" are just the most visible "
    ...
    add_exit( "grassyfield", TERRAINTUTOR "grassystep", "hidden" );
    add_exit( "desert", TERRAINTUTOR "sandtent", "hidden" );
    add_exit( "mountaintop", TERRAINTUTOR "mountaincabin", "hidden" );
