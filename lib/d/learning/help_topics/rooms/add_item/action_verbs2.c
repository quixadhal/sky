...
void setup() {
   ...
   add_item("dirty can", ({ "long", "It looks like it wants to be touched.",
       "touch", ({ this_object(), "always_fail" }) }));
   ...
   add_item("large filthy rat", ({ "long", "It looks like it wants to be touched.",
