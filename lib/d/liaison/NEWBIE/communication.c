...
/*
 * $Locker:  $
 * $Id: communication.c,v 1.3 2000/06/22 01:00:03 pinkfish Exp $
 *
*/
...
void setup() {
  ...
  sign=add_sign("A poster entitled 'Womble On'\n",
           ...
           "approximately 300 soul commands so they are not listed here.  "
