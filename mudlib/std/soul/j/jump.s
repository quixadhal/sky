(jump
  ...
  (single
    (arguments
      ...
      (rest "$mcname$ $position$jumps up and down $arg$.")
      (position
        (standing "ignore")
        (default
          (cmd "stand")
  ...
  (targeted
    (no-arguments
      ...
      (target "$mcname$ $aposition$jumps up and down on you.")
      (rest  "$mcname$ $aposition$jumps up and down on $hcname$.")
      (position
        (actor
          (default
            (cmd "stand")
    ...
    (arguments
      ...
      (target "$mcname$ $aposition$jumps up and down on you $arg$.")
      (rest  "$mcname$ $aposition$jumps up and down on $hcname$ $arg$.")
      (position
        (actor
          (default
            (cmd "stand")
