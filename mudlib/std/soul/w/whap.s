(whap
  ...
  (targeted
    (no-arguments
      ...
      (target "$mcname$ whaps you over the head.")
      (rest  "$mcname$ whaps $hcname$ over the head.")
    )
    (arguments
     ...
     violently,lovingly,repeatedly,like a knight with a fish in shining armour,# )
      ...
      (target "$mcname$ whaps you over the head $arg$.")
      (rest  "$mcname$ whaps $hcname$ over the head $arg$.")
    )
  )
)
