...
void setup() {
   ...
   set_name("bug");
   set_long(
"It sits there, happier than a clam, its long black silvery legs sticking "
"out the side.  "
"The legs look "
"fixed in place and there are some silvery words carved onto the top.  "
"When you shake it, it sounds like it has something rattling around "
"inside.  There appears to be a spray nozzle at one end.\n");
   add_read_mess("68000\n", "silver writing", "common", 0);
} /* setup() */
