...
void setup() {
    ...
    set_long("Scarlet red petals curl slightly downwards around the tiny "
        "mauve centre of this orinatra.  White zig-zags run along the length "
        "of its tough, green leathery stem.\n");

    set_withered_long("The curled petals of the orinatra have become crumpled "
        "and turned to a brown hue with only patches of red left in the "
