...
#define USER_COLOUR_LIST ({"shout", "tell", "say", "whisper", "soul", \
                           "emote", "remote", "exits", "inventory", \
                           "weather", "group", "shopchat" })
#define CRE_COLOUR_LIST ({"cre"})
#define LORD_COLOUR_LIST ({"lord"})
#endif /* __SYS__COLOUR */
