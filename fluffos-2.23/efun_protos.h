...
void f_add_a (void);
void f_vowel (void);
void f_replace_html (void);
void f_replace_mxp (void);
void f_roulette_wheel (void);
void f_replace_objects (void);
...
void f_query_multiple_short (void);
void f_reference_allowed (void);
void f_roll_MdN (void);
void f_replace (void);
void f_replace_dollars (void);
