...
{"add_a",F_ADD_A,0,0,1,1,TYPE_STRING,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
...
{"allocate",F_ALLOCATE,0,0,1,2,TYPE_MOD_ARRAY|TYPE_ANY,T_NUMBER,T_ANY,T_ANY,T_ANY,161,DEFAULT_NONE},
{"allocate_buffer",F_ALLOCATE_BUFFER,0,0,1,1,TYPE_BUFFER,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"allocate_mapping",F_ALLOCATE_MAPPING,0,0,1,2,TYPE_MAPPING,T_NUMBER|T_ARRAY,T_ANY,T_ANY,T_ANY,131,DEFAULT_NONE},
{"angle",F_ANGLE,0,0,2,2,TYPE_REAL,T_ARRAY|T_ARRAY,T_ARRAY|T_ARRAY,T_ANY,T_ANY,258,DEFAULT_NONE},
...
{"base_name",F_BASE_NAME,0,0,1,1,TYPE_STRING,T_STRING|T_OBJECT,T_ANY,T_ANY,T_ANY,292,DEFAULT_THIS_OBJECT},
...
{"classes",F_CLASSES,0,0,2,2,TYPE_MOD_ARRAY|TYPE_ANY,T_OBJECT,T_NUMBER,T_ANY,T_ANY,199,0},
{"classp",F_CLASSP,0,0,1,1,TYPE_NUMBER,T_ANY,T_ANY,T_ANY,T_ANY,8,DEFAULT_NONE},
{"clear_bit",F_CLEAR_BIT,0,0,2,2,TYPE_STRING,T_STRING,T_NUMBER,T_ANY,T_ANY,97,DEFAULT_NONE},
...
{"crc32",F_CRC32,0,0,1,1,TYPE_NUMBER,T_STRING|T_BUFFER,T_ANY,T_ANY,T_ANY,113,DEFAULT_NONE},
{"crypt",F_CRYPT,0,0,2,2,TYPE_STRING,T_STRING,T_STRING|T_NUMBER,T_ANY,T_ANY,106,DEFAULT_NONE},
{"ctime",F_CTIME,0,0,0,1,TYPE_STRING,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"debug_info",F_DEBUG_INFO,0,0,2,2,TYPE_ANY,T_NUMBER,T_OBJECT,T_ANY,T_ANY,191,DEFAULT_NONE},
...
{"distance",F_DISTANCE,0,0,2,2,TYPE_REAL,T_ARRAY|T_ARRAY,T_ARRAY|T_ARRAY,T_ANY,T_ANY,258,DEFAULT_NONE},
{"dotprod",F_DOTPROD,0,0,2,2,TYPE_REAL,T_ARRAY|T_ARRAY,T_ARRAY|T_ARRAY,T_ANY,T_ANY,261,DEFAULT_NONE},
{"dump_file_descriptors",F_DUMP_FILE_DESCRIPTORS,0,0,0,0,TYPE_STRING,T_ANY,T_ANY,T_ANY,T_ANY,0,DEFAULT_NONE},
{"dump_prog",F_DUMP_PROG,0,0,1,-1,TYPE_NOVALUE,T_OBJECT,T_ANY,T_ANY,T_ANY,267,DEFAULT_NONE},
{"dumpallobj",F_DUMPALLOBJ,0,0,0,1,TYPE_NOVALUE,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"ed",F_ED,0,0,0,5,TYPE_NOVALUE,T_STRING,T_STRING|T_NUMBER,T_STRING|T_NUMBER,T_NUMBER,216,DEFAULT_NONE},
...
{"event",F_EVENT,0,0,2,-1,TYPE_NOVALUE,T_OBJECT|T_ARRAY,T_STRING,T_ANY,T_ANY,286,DEFAULT_NONE},
{"exec",F_EXEC,0,0,2,2,TYPE_NUMBER,T_OBJECT,T_OBJECT,T_ANY,T_ANY,193,DEFAULT_NONE},
...
{"fetch_class_member",F_FETCH_CLASS_MEMBER,0,0,2,2,TYPE_ANY,T_ANY,T_NUMBER,T_ANY,T_ANY,159,DEFAULT_NONE},
...
{"filter",F_FILTER,0,0,2,-1,TYPE_ANY,T_STRING|T_ARRAY|T_MAPPING,T_STRING|T_FUNCTION,T_ANY,T_ANY,228,DEFAULT_NONE},
{"filter_array",F_FILTER | F_ALIAS_FLAG,0,0,2,-1,TYPE_ANY,T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,210,DEFAULT_NONE},
{"filter_mapping",F_FILTER | F_ALIAS_FLAG,0,0,2,-1,TYPE_MAPPING,T_MAPPING,T_STRING|T_FUNCTION,T_ANY,T_ANY,230,DEFAULT_NONE},
{"find_call_out",F_FIND_CALL_OUT,0,0,1,1,TYPE_NUMBER,T_NUMBER|T_STRING,T_ANY,T_ANY,T_ANY,128,DEFAULT_NONE},
{"find_object",F_FIND_OBJECT,0,0,2,2,TYPE_OBJECT,T_STRING,T_NUMBER,T_ANY,T_ANY,97,0},
...
{"function_exists",F_FUNCTION_EXISTS,0,0,1,3,TYPE_STRING,T_STRING,T_OBJECT,T_NUMBER,T_ANY,197,DEFAULT_NONE},
...
{"functions",F_FUNCTIONS,0,0,2,2,TYPE_MOD_ARRAY|TYPE_ANY,T_OBJECT,T_NUMBER,T_ANY,T_ANY,199,0},
...
{"get_dir",F_GET_DIR,0,0,2,2,TYPE_MOD_ARRAY|TYPE_ANY,T_STRING,T_NUMBER,T_ANY,T_ANY,97,0},
{"get_garbage",F_GET_GARBAGE,0,0,0,0,TYPE_MOD_ARRAY|TYPE_OBJECT,T_ANY,T_ANY,T_ANY,T_ANY,0,DEFAULT_NONE},
{"geteuid",F_GETEUID,0,0,1,1,TYPE_STRING,T_FUNCTION|T_OBJECT,T_ANY,T_ANY,T_ANY,249,DEFAULT_THIS_OBJECT},
...
{"is_daylight_savings_time",F_IS_DAYLIGHT_SAVINGS_TIME,0,0,2,2,TYPE_NUMBER,T_STRING,T_NUMBER,T_ANY,T_ANY,97,DEFAULT_NONE},
{"keys",F_KEYS,0,0,1,1,TYPE_MOD_ARRAY|TYPE_ANY,T_MAPPING,T_ANY,T_ANY,T_ANY,136,DEFAULT_NONE},
{"link",F_LINK,0,0,2,2,TYPE_NUMBER,T_STRING,T_STRING,T_ANY,T_ANY,27,DEFAULT_NONE},
{"load_object",F_FIND_OBJECT | F_ALIAS_FLAG,0,0,2,2,TYPE_OBJECT,T_STRING,T_NUMBER,T_ANY,T_ANY,97,1},
...
{"map",F_MAP,0,0,2,-1,TYPE_ANY,T_STRING|T_MAPPING|T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,236,DEFAULT_NONE},
{"map_array",F_MAP | F_ALIAS_FLAG,0,0,2,-1,TYPE_MOD_ARRAY|TYPE_ANY,T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,210,DEFAULT_NONE},
{"map_delete",F_MAP_DELETE,0,0,2,2,TYPE_NOVALUE,T_MAPPING,T_ANY,T_ANY,T_ANY,138,DEFAULT_NONE},
{"map_mapping",F_MAP | F_ALIAS_FLAG,0,0,2,-1,TYPE_MAPPING,T_MAPPING,T_STRING|T_FUNCTION,T_ANY,T_ANY,230,DEFAULT_NONE},
...
{"match_path",F_MATCH_PATH,0,0,2,2,TYPE_ANY,T_MAPPING,T_STRING,T_ANY,T_ANY,142,DEFAULT_NONE},
...
{"message",F_MESSAGE,0,0,3,4,TYPE_NOVALUE,T_ANY,T_ANY,T_STRING|T_ARRAY|T_OBJECT|T_ARRAY,T_OBJECT|T_ARRAY,116,DEFAULT_NONE},
...
{"next_bit",F_NEXT_BIT,0,0,2,2,TYPE_NUMBER,T_STRING,T_NUMBER,T_ANY,T_ANY,97,DEFAULT_NONE},
{"next_inventory",F_NEXT_INVENTORY,0,0,1,1,TYPE_OBJECT,T_OBJECT,T_ANY,T_ANY,T_ANY,25,DEFAULT_THIS_OBJECT},
{"norm",F_NORM,0,0,1,1,TYPE_REAL,T_ARRAY|T_ARRAY,T_ANY,T_ANY,T_ANY,258,DEFAULT_NONE},
...
{"oldcrypt",F_OLDCRYPT,0,0,2,2,TYPE_STRING,T_STRING,T_STRING|T_NUMBER,T_ANY,T_ANY,106,DEFAULT_NONE},
...
{"pow",F_POW,0,0,2,2,TYPE_REAL,T_REAL|T_NUMBER,T_REAL|T_NUMBER,T_ANY,T_ANY,252,DEFAULT_NONE},
...
{"query_multiple_short",F_QUERY_MULTIPLE_SHORT,0,0,1,5,TYPE_STRING,T_ARRAY,T_NUMBER|T_STRING,T_NUMBER,T_NUMBER,342,DEFAULT_NONE},
...
{"read_buffer",F_READ_BUFFER,0,0,1,3,TYPE_ANY,T_STRING|T_BUFFER,T_NUMBER,T_NUMBER,T_ANY,165,DEFAULT_NONE},
{"read_bytes",F_READ_BYTES,0,0,1,3,TYPE_STRING,T_STRING,T_NUMBER,T_NUMBER,T_ANY,187,DEFAULT_NONE},
{"read_file",F_READ_FILE,0,0,1,3,TYPE_STRING,T_STRING,T_NUMBER,T_NUMBER,T_ANY,187,DEFAULT_NONE},
{"real_time",F_REAL_TIME,0,0,0,0,TYPE_NUMBER,T_ANY,T_ANY,T_ANY,T_ANY,0,DEFAULT_NONE},
{"receive",F_RECEIVE,0,0,1,1,TYPE_NOVALUE,T_STRING|T_BUFFER,T_ANY,T_ANY,T_ANY,113,DEFAULT_NONE},
{"reclaim_objects",F_RECLAIM_OBJECTS,0,0,0,0,TYPE_NUMBER,T_ANY,T_ANY,T_ANY,T_ANY,0,DEFAULT_NONE},
{"reference_allowed",F_REFERENCE_ALLOWED,0,0,1,2,TYPE_NUMBER,T_OBJECT,T_STRING|T_OBJECT,T_ANY,T_ANY,353,DEFAULT_NONE},
{"refs",F_REFS,0,0,1,1,TYPE_NUMBER,T_ANY,T_ANY,T_ANY,T_ANY,8,DEFAULT_NONE},
{"reg_assoc",F_REG_ASSOC,0,0,3,4,TYPE_MOD_ARRAY|TYPE_ANY,T_STRING,T_ARRAY,T_ARRAY,T_ANY,153,DEFAULT_NONE},
{"regexp",F_REGEXP,0,0,2,3,TYPE_ANY,T_STRING|T_ARRAY,T_STRING,T_NUMBER,T_ANY,146,DEFAULT_NONE},
{"reload_object",F_RELOAD_OBJECT,0,0,1,1,TYPE_NOVALUE,T_OBJECT,T_ANY,T_ANY,T_ANY,25,DEFAULT_NONE},
{"remove_call_out",F_REMOVE_CALL_OUT,0,0,0,1,TYPE_NUMBER,T_NUMBER|T_STRING,T_ANY,T_ANY,T_ANY,128,DEFAULT_NONE},
...
{"repeat_string",F_REPEAT_STRING,0,0,2,2,TYPE_STRING,T_STRING,T_NUMBER,T_ANY,T_ANY,97,DEFAULT_NONE},
{"replace",F_REPLACE,0,0,2,3,TYPE_STRING,T_STRING,T_ARRAY|T_STRING,T_STRING,T_ANY,358,DEFAULT_NONE},
{"replace_dollars",F_REPLACE_DOLLARS,0,0,2,2,TYPE_STRING,T_STRING,T_ARRAY,T_ANY,T_ANY,153,DEFAULT_NONE},
{"replace_html",F_REPLACE_HTML,0,0,1,1,TYPE_STRING,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"replace_mxp",F_REPLACE_MXP,0,0,1,1,TYPE_STRING,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"replace_objects",F_REPLACE_OBJECTS,0,0,1,1,TYPE_ANY,T_ANY,T_ANY,T_ANY,T_ANY,8,DEFAULT_NONE},
{"replace_program",F_REPLACE_PROGRAM,0,0,1,1,TYPE_NOVALUE,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"replace_string",F_REPLACE_STRING,0,0,3,-1,TYPE_STRING,T_STRING,T_STRING,T_STRING,T_ANY,90,DEFAULT_NONE},
{"replaceable",F_REPLACEABLE,0,0,1,2,TYPE_NUMBER,T_OBJECT,T_ARRAY,T_ANY,T_ANY,278,DEFAULT_NONE},
...
{"resolve",F_RESOLVE,0,0,2,2,TYPE_NUMBER,T_STRING,T_STRING|T_FUNCTION,T_ANY,T_ANY,244,DEFAULT_NONE},
{"restore_from_string",F_RESTORE_FROM_STRING,0,0,2,2,TYPE_NOVALUE,T_STRING,T_NUMBER,T_ANY,T_ANY,97,0},
{"restore_object",F_RESTORE_OBJECT,0,0,1,2,TYPE_NUMBER,T_STRING,T_NUMBER,T_ANY,T_ANY,97,DEFAULT_NONE},
...
{"roll_MdN",F_ROLL_MDN,0,0,2,2,TYPE_NUMBER,T_NUMBER,T_NUMBER,T_ANY,T_ANY,49,DEFAULT_NONE},
{"roulette_wheel",F_ROULETTE_WHEEL,0,0,1,1,TYPE_ANY,T_MAPPING,T_ANY,T_ANY,T_ANY,136,DEFAULT_NONE},
...
{"save_object",F_SAVE_OBJECT,0,0,0,2,TYPE_ANY,T_STRING|T_NUMBER,T_NUMBER,T_ANY,T_ANY,101,DEFAULT_NONE},
...
{"send_zmp",F_SEND_ZMP,0,0,2,2,TYPE_NOVALUE,T_STRING,T_ARRAY,T_ANY,T_ANY,153,DEFAULT_NONE},
{"set_bit",F_SET_BIT,0,0,2,2,TYPE_STRING,T_STRING,T_NUMBER,T_ANY,T_ANY,97,DEFAULT_NONE},
...
{"set_reset",F_SET_RESET,0,0,1,2,TYPE_NOVALUE,T_OBJECT,T_NUMBER,T_ANY,T_ANY,199,DEFAULT_NONE},
{"set_this_player",F_SET_THIS_PLAYER,0,0,1,1,TYPE_NOVALUE,T_OBJECT|T_NUMBER,T_ANY,T_ANY,T_ANY,87,DEFAULT_NONE},
{"set_this_user",F_SET_THIS_PLAYER | F_ALIAS_FLAG,0,0,1,1,TYPE_NOVALUE,T_OBJECT|T_NUMBER,T_ANY,T_ANY,T_ANY,87,DEFAULT_NONE},
{"seteuid",F_SETEUID,0,0,1,1,TYPE_NUMBER,T_STRING|T_NUMBER,T_ANY,T_ANY,T_ANY,101,DEFAULT_NONE},
{"shadow",F_SHADOW,0,0,2,2,TYPE_OBJECT,T_OBJECT,T_NUMBER,T_ANY,T_ANY,199,1},
...
{"snoop",F_SNOOP,0,0,1,2,TYPE_OBJECT,T_OBJECT,T_OBJECT,T_ANY,T_ANY,193,DEFAULT_NONE},
{"socket_accept",F_SOCKET_ACCEPT,0,0,3,3,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_ANY,295,DEFAULT_NONE},
{"socket_acquire",F_SOCKET_ACQUIRE,0,0,4,4,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,326,DEFAULT_NONE},
{"socket_address",F_SOCKET_ADDRESS,0,0,2,2,TYPE_STRING,T_NUMBER|T_OBJECT,T_NUMBER,T_ANY,T_ANY,337,0},
{"socket_bind",F_SOCKET_BIND,0,0,2,3,TYPE_NUMBER,T_NUMBER,T_NUMBER,T_STRING,T_ANY,102,DEFAULT_NONE},
{"socket_close",F_SOCKET_CLOSE,0,0,1,1,TYPE_NUMBER,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"socket_connect",F_SOCKET_CONNECT,0,0,4,4,TYPE_NUMBER,T_NUMBER,T_STRING,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,303,DEFAULT_NONE},
{"socket_create",F_SOCKET_CREATE,0,0,2,3,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_ANY,295,DEFAULT_NONE},
...
{"socket_release",F_SOCKET_RELEASE,0,0,3,3,TYPE_NUMBER,T_NUMBER,T_OBJECT,T_STRING|T_FUNCTION,T_ANY,319,DEFAULT_NONE},
{"socket_status",F_SOCKET_STATUS,0,0,0,1,TYPE_MOD_ARRAY|TYPE_ANY,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"socket_write",F_SOCKET_WRITE,0,0,2,3,TYPE_NUMBER,T_NUMBER,T_ANY,T_STRING,T_ANY,313,DEFAULT_NONE},
{"sort_array",F_SORT_ARRAY,0,0,2,-1,TYPE_MOD_ARRAY|TYPE_ANY,T_ARRAY,T_NUMBER|T_STRING|T_FUNCTION,T_ANY,T_ANY,203,DEFAULT_NONE},
...
{"stat",F_STAT,0,0,2,2,TYPE_MOD_ARRAY|TYPE_ANY,T_STRING,T_NUMBER,T_ANY,T_ANY,97,0},
{"store_class_member",F_STORE_CLASS_MEMBER,0,0,3,3,TYPE_ANY,T_ANY,T_NUMBER,T_ANY,T_ANY,159,DEFAULT_NONE},
{"store_variable",F_STORE_VARIABLE,0,0,2,2,TYPE_NOVALUE,T_STRING,T_ANY,T_ANY,T_ANY,282,DEFAULT_NONE},
...
{"strsrch",F_STRSRCH,0,0,3,3,TYPE_NUMBER,T_STRING,T_STRING|T_NUMBER,T_NUMBER,T_ANY,106,0},
...
{"terminal_colour",F_TERMINAL_COLOUR,0,0,2,4,TYPE_STRING,T_STRING,T_MAPPING,T_NUMBER,T_NUMBER,270,DEFAULT_NONE},
{"test_bit",F_TEST_BIT,0,0,2,2,TYPE_NUMBER,T_STRING,T_NUMBER,T_ANY,T_ANY,97,DEFAULT_NONE},
...
{"traceprefix",F_TRACEPREFIX,0,0,1,1,TYPE_STRING,T_STRING|T_NUMBER,T_ANY,T_ANY,T_ANY,101,DEFAULT_NONE},
...
{"unique_mapping",F_UNIQUE_MAPPING,0,0,2,-1,TYPE_MAPPING,T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,210,DEFAULT_NONE},
...
{"values",F_VALUES,0,0,1,1,TYPE_MOD_ARRAY|TYPE_ANY,T_MAPPING,T_ANY,T_ANY,T_ANY,136,DEFAULT_NONE},
{"variables",F_VARIABLES,0,0,2,2,TYPE_MOD_ARRAY|TYPE_ANY,T_OBJECT,T_NUMBER,T_ANY,T_ANY,199,0},
{"virtualp",F_VIRTUALP,0,0,1,1,TYPE_NUMBER,T_OBJECT,T_ANY,T_ANY,T_ANY,25,DEFAULT_THIS_OBJECT},
{"vowel",F_VOWEL,0,0,1,1,TYPE_NUMBER,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"write",F_WRITE,0,0,1,1,TYPE_NOVALUE,T_ANY,T_ANY,T_ANY,T_ANY,8,DEFAULT_NONE},
{"write_buffer",F_WRITE_BUFFER,0,0,3,3,TYPE_NUMBER,T_STRING|T_BUFFER,T_NUMBER,T_STRING|T_BUFFER|T_NUMBER,T_ANY,172,DEFAULT_NONE},
{"write_bytes",F_WRITE_BYTES,0,0,3,3,TYPE_NUMBER,T_STRING,T_NUMBER,T_STRING,T_ANY,149,DEFAULT_NONE},
{"write_file",F_WRITE_FILE,0,0,3,3,TYPE_NUMBER,T_STRING,T_STRING,T_NUMBER,T_ANY,181,0},
{"zonetime",F_ZONETIME,0,0,2,2,TYPE_STRING,T_STRING,T_NUMBER,T_ANY,T_ANY,97,DEFAULT_NONE},
...
TYPE_STRING,TYPE_OBJECT,0,
TYPE_STRING,0,
TYPE_MOD_ARRAY|TYPE_STRING,TYPE_STRING,0,
TYPE_STRING,0,
};
